...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/container.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/container.classes');
