...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/gradients.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/gradients.classes');
