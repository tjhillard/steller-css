...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/overflow.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/overflow.classes');
