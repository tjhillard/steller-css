...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/grid-columns-rows.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/grid-columns-rows.classes');
