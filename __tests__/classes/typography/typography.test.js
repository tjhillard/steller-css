...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/typography.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/typography.classes');
