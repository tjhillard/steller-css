...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/interactivity.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/interactivity.classes');
