...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/font-size-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/font-size.classes');
