...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/color-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/color.classes');
