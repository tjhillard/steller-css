...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/border-width-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/border-width.classes');
