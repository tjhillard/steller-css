...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/breakpoint-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/breakpoint.classes');
