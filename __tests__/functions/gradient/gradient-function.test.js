...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/gradient-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/gradient.classes');
