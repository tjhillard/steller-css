...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/spacing-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/spacing.classes');
