...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/box-shadow-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/box-shadow.classes');
