...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/column-gutter-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/column-gutter.classes');
