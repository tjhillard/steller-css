...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/duration-function.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/duration.classes');
