...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/transforms.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/transforms.classes');
