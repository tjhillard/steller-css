...
const html = fs.readFileSync(path.resolve(__dirname, '././__fixtures__/backgrounds.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/backgrounds.classes');
