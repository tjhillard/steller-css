...
const html = fs.readFileSync(path.resolve(__dirname, './__fixtures__/transitions.html'), 'utf8');
const classesWithExpectedStyles = require('./__fixtures__/transitions.classes');
